...
export type { QueryOperator } from '../constants/query-operators';
...
export type QueryRuleValue = string | number | string[] | number[] | boolean;
...
export interface IDenormalizedGroupNodeWithModifiers extends IDenormalizedGroupNodeBase {
  value: QueryGroupValue;
  isNegated: boolean;
}

export interface IDenormalizedGroupNodeWithoutModifiers extends IDenormalizedGroupNodeBase {
  value?: undefined;
  isNegated?: undefined;
}
...
export interface INormalizedFieldReferenceRuleNode extends INormalizedRuleNodeBase {
  valueSource: 'field';
  value?: undefined;
  valueField: string;
}
...
export interface INormalizedGroupNodeWithModifiers extends INormalizedGroupNodeBase {
  value: QueryGroupValue;
  isNegated: boolean;
}

export interface INormalizedGroupNodeWithoutModifiers extends INormalizedGroupNodeBase {
  value?: undefined;
  isNegated?: undefined;
}
