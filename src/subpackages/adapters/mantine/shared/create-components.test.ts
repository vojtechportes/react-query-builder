import { createMantineComponents } from './create-components';

describe('#adapters/mantine/shared/create-components', () => {
  it('merges top-level and form component overrides', () => {
    ...
    expect(createMantineComponents(base, overrides)).toMatchObject({
      Add: BaseAdd,
