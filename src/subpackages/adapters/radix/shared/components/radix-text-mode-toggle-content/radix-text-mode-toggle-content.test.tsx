...
import { RadixTextModeToggleContent } from './radix-text-mode-toggle-content';
import styles from './radix-text-mode-toggle-content.module.css';

describe('#radix/components/RadixTextModeToggleContent', () => {
  it.each([
    ...
    const { container } = render(
      <RadixTextModeToggleContent mode={mode} label={`${mode} label`} />
    );
  ...
  it('renders without styled-components runtime classes during SSR', () => {
    const markup = renderToStaticMarkup(
      <RadixTextModeToggleContent mode="builder" label="Use SQL" />
    );
