...
describe('parseQuery SpEL', () => {
  it('parses logical groups and comparisons', () => {
    const result = parseQuery("(status == 'active' and age >= 18)", 'SpEL');
  ...
  it('keeps boolean rhs values as literals', () => {
    const result = parseQuery('(active == true and archived != false)', 'SpEL');
  ...
  it('still collapses literal not-between ranges normally', () => {
    const result = parseQuery('(price < 10 or price > 20)', 'SpEL');
  ...
  it('still collapses literal ranges normally', () => {
    const result = parseQuery('(price >= 10 and price <= 20)', 'SpEL');
