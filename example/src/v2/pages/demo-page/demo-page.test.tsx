...
vi.mock('./components/demo-playground', () => ({
  DemoPlayground: () => <div>v2 playground</div>,
}));
...
describe('v2 DemoPage', () => {
  it('renders the v2-owned copy and client-only playground boundary', () => {
    render(<DemoPage />);
  ...
  it('loads the v2-owned playground', async () => {
