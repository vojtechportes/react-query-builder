...
import { componentsSnippet } from '../constants/components-snippet';
  ...
  <>
    ...
    <List>
      ...
      <li>
        ...
        <InlineCode>PopoverItem</InlineCode> should preserve click semantics and
        remain accessible.
      </li>
      <li>
        <InlineCode>HistoryControls</InlineCode> receives built-in undo and redo
        button nodes plus history state and handlers, so custom layouts can
        reuse the default controls instead of recreating them.
      </li>
      <li>
    ...
    <AlertBox title="Adapter packages" variant="info">
      If you want ready-made component mappings instead of wiring every override
      by hand, see <TextLink to="/documentation/adapters">Adapters</TextLink>.
    </AlertBox>
