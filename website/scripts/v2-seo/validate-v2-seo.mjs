...
const distRoot = path.join(websiteRoot, '.versioned-dist', 'v2');
...
const errors = [
  ...
  ...getV2SeoOwnershipErrors([
    path.join(websiteRoot, 'src', 'v2', 'seo'),
    path.join(websiteRoot, 'src', 'v2', 'pages'),
    path.join(websiteRoot, 'scripts', 'v2-seo'),
  ]),
];
